# Generated by Django 3.2.13 on 2022-05-26 00:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groupe', models.ForeignKey(blank=True, db_column='nom_groupe', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='regroupements', related_query_name='regroupement', to='time_table.groupe')),
                ...
                ('specialite', models.ForeignKey(blank=True, db_column='nom_specialite', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='regroupements', related_query_name='regroupement', to='time_table.specialite')),
                ('ue', models.ForeignKey(blank=True, db_column='code_ue', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='regroupements', related_query_name='regroupement', to='time_table.ue')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='cours',
            name='salle',
            field=models.ForeignKey(blank=True, db_column='nom_salle', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cours', related_query_name='cours', to='time_table.salle'),
        ),
    ]
