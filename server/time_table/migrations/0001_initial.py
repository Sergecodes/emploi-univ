# Generated by Django 3.2.13 on 2022-05-25 00:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Cours',
            fields=[
                ('ue', models.OneToOneField(db_column='code_ue', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='time_table.ue')),
                ('jour', models.CharField(blank=True, choices=[('LUN', 'Lundi'), ('MAR', 'Mardi'), ('MER', 'Mercredi'), ('JEU', 'Jeudi'), ('VEN', 'Vendredi'), ('SAM', 'Samedi'), ('DIM', 'Dimanche')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ue', models.ForeignKey(blank=True, db_column='code_ue', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='regroupements', related_query_name='regroupement', to='time_table.ue')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='cours',
            name='enseignant',
            field=models.ForeignKey(db_column='matricule_ens', on_delete=django.db.models.deletion.CASCADE, related_name='cours', related_query_name='cours', to='time_table.enseignant'),
        ),
        migrations.AddField(
            model_name='cours',
            name='salle',
            field=models.ForeignKey(blank=True, db_column='nom_salle', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cours', related_query_name='cours', to='time_table.salle'),
        ),
    ]
