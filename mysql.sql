...
--
CREATE TABLE `enseignant` (`matricule` varchar(15) NOT NULL PRIMARY KEY, `nom` varchar(50) NOT NULL, `prenom` varchar(50) NOT NULL) ENGINE=InnoDB;
--
-- Create model Filiere
--
CREATE TABLE `filiere` (`nom` varchar(20) NOT NULL PRIMARY KEY) ENGINE=InnoDB;
--
-- Create model Groupe
--
CREATE TABLE `groupe` (`nom` varchar(20) NOT NULL PRIMARY KEY) ENGINE=InnoDB;
--
-- Create model Niveau
--
CREATE TABLE `niveau` (`nom_bref` varchar(10) NOT NULL PRIMARY KEY, `nom_complet` varchar(20) NOT NULL UNIQUE, `nb_max` int UNSIGNED NOT NULL CHECK (`nb_max` >= 0)) ENGINE=InnoDB;
--
-- Create model Salle
--
CREATE TABLE `salle` (`nom` varchar(10) NOT NULL PRIMARY KEY, `capacite` smallint UNSIGNED NOT NULL CHECK (`capacite` >= 0)) ENGINE=InnoDB;
--
-- Create model Specialite
--
CREATE TABLE `specialite` (`nom` varchar(20) NOT NULL PRIMARY KEY) ENGINE=InnoDB;
--
-- Create model UE
--
CREATE TABLE `ue` (`code` varchar(10) NOT NULL PRIMARY KEY, `intitule` varchar(50) NOT NULL) ENGINE=InnoDB;
--
-- Create model Cours
--
CREATE TABLE `cours` (`id_cours` int AUTO_INCREMENT  PRIMARY KEY, `code_ue` varchar(10) NOT NULL, `jour` varchar(3) NOT NULL, `heure_debut` time(6) NOT NULL, `heure_fin` time(6) NOT NULL, `is_td` bool NOT NULL, `is_virtuel` bool NOT NULL) ENGINE=InnoDB;
--
-- Create model Regroupement
--
CREATE TABLE `regroupement` (`id_regroupement` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `nom_filiere` varchar(20) NOT NULL, `nom_groupe` varchar(20) NULL, `nom_niveau` varchar(10) NOT NULL, `nom_specialite` varchar(20) NULL, `code_ue` varchar(10) NULL, `effectif_max` int(10) unsigned NULL CHECK (`effectif_max` >= 0)) ENGINE=InnoDB; 
--
