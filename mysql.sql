...
-- Create model Cours
--
CREATE TABLE `cours` (`code_ue` varchar(10) NOT NULL PRIMARY KEY, `jour` varchar(3) NOT NULL, `heure_debut` time(6) NOT NULL, `heure_fin` time(6) NOT NULL, `is_td` bool NOT NULL, `is_virtuel` bool NOT NULL) ENGINE=InnoDB;
--
