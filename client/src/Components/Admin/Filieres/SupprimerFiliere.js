...
const SupprimerFiliere = (props) => {
  ...
  const headers={
    ...
    const handleDelete=()=>{
      axios({
        method:'delete',
        url:`http://localhost:8000/api/filieres/${encodeURIComponent(props.nom)}/`,
        headers:headers,
            ...
            >
              <div className="ajout mt-5  px-3 py-2 col-12 col-md-9 col-lg-6">
                <h4 className="fs-5 fw-light text-center">
                  Voulez vous vraiment Supprimer la filiere {props.nom}?
                </h4>
                <div
...
export default SupprimerFiliere